...
class SlowControl(StatusChecker):
  ...
  def CheckStatus(self):
    ...
    if DAQUtils.KeithleyIsOK():
      self.data.append( StatusDatum( "Keithley Monitor Alive?", "Yes" ) )
    else:
      self.data.append( StatusDatum( "Keithley Monitor Alive?", "NO", problem=True ) )
...
allCheckers = [ spillCounterChecker, slowControlChecker, beamDAQChecker, mainDAQChecker, scalerDAQChecker, decoderChecker, diskChecker, CAENChecker]
